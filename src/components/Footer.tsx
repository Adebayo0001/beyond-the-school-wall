    ...
    <footer className="bg-white pt-24 pb-12 border-t border-[#e8e5e0]">
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  <li key={social.name}>
                    <a href="#" className="flex items-center gap-3 text-[#6b6b6b] hover:text-[#F16736] transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-4 text-[#6b6b6b] text-sm font-medium">
                <li><Link to="/#intelligence" className="hover:text-[#F16736] transition-colors">About Us</Link></li>
                <li><Link to="/programs" className="hover:text-[#F16736] transition-colors">Curriculum</Link></li>
                <li><a href="#" className="hover:text-[#F16736] transition-colors">Orange-Mart</a></li>
                <li><a href="#" className="hover:text-[#F16736] transition-colors">Privacy Policy</a></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="pt-12 border-t border-[#e8e5e0] flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <button 
            onClick={scrollToTop}
            className="text-[#6b6b6b] hover:text-[#F16736] text-sm font-bold flex items-center gap-2 transition-colors"
          >

      ...
      <div className="max-w-5xl mx-auto px-6 space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 text-left">
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <Link href="/portal"
                className="px-8 py-4 bg-[#1e1e1e] hover:bg-[#F16736] text-white font-extrabold text-xs uppercase tracking-wider rounded-lg transition-all hover:shadow-lg cursor-pointer"
              >
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-br from-[#F16736]/10 to-transparent rounded-xl -rotate-2 scale-105 pointer-events-none" />
            <div className="p-8 border-2 border-[#e8e5e0] rounded-xl bg-[#faf9f7] relative space-y-4">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
            {[
              ...
              <div key={idx} className="p-6 border border-[#e8e5e0] rounded-xl bg-neutral-50/50 space-y-3 text-left">
        ...
        <div className="space-y-6 pt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {games.map((game, idx) => (
              <div key={idx} className="p-6 border border-[#e8e5e0] rounded-xl bg-white hover:border-[#F16736]/40 transition-all flex flex-col justify-between text-left shadow-sm">

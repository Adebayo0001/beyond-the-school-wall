    ...
    <div className="min-h-screen bg-white text-[#1e1e1e] font-sans selection:bg-[#F16736]/20 relative overflow-x-hidden pt-16 text-left">
          ...
          <div className="flex-1 space-y-6">
            ...
            <div className="flex flex-wrap gap-4 pt-3">
              <button 
                ...
                className="px-6 py-3 bg-[#F16736] hover:bg-[#F16736]/90 text-white text-xs font-black uppercase tracking-wider rounded-lg transition hover:scale-103 shadow-md cursor-pointer"
              >
                Join Mentorship
              </button>
              <button 
                onClick={() => setGrantModalOpen(true)}
                className="px-6 py-3 bg-neutral-800 border border-neutral-700 hover:bg-neutral-700 text-neutral-200 text-xs font-black uppercase tracking-wider rounded-lg transition cursor-pointer"
              >
                Apply for Grants
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="pt-4">
              <button
                onClick={() => setMentorshipModalOpen(true)}
                className="px-8 py-3.5 bg-[#F16736] text-white font-extrabold text-xs uppercase tracking-widest rounded-lg transition-all hover:shadow-[0_0_20px_rgba(241,103,54,0.3)] hover:scale-102 cursor-pointer flex items-center gap-2"
              >
          ...
          <div className="bg-[#faf9f7] rounded-3xl p-8 border border-[#e8e5e0] relative overflow-hidden flex flex-col justify-between aspect-[4/3]">
            ...
            <div className="space-y-4">
              <span className="text-[10px] font-mono bg-[#fff1eb] text-[#F16736] border border-[#F16736]/10 px-2.5 py-0.5 rounded-md font-black">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="pt-4">
              <button
                onClick={() => setGrantModalOpen(true)}
                className="px-8 py-3.5 bg-neutral-900 text-white font-extrabold text-xs uppercase tracking-widest rounded-lg transition-all hover:bg-neutral-800 cursor-pointer flex items-center gap-2"
              >
        ...
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <div className="relative">
            ...
            <div className="flex gap-4 overflow-x-auto pb-6 scrollbar-thin scrollbar-thumb-neutral-200">
              {universities.map((uni, idx) => (
                <div 
                  key={idx} 
                  className="min-w-[200px] flex-shrink-0 bg-[#faf9f7] rounded-xl border border-[#e8e5e0] p-5 text-left flex flex-col justify-between min-h-[140px] hover:border-[#F16736] transition-all"
                >
                  <div className={`w-9 h-9 rounded-lg bg-gradient-to-br ${uni.color} flex items-center justify-center text-white font-extrabold text-xs`}>
          ...
          <div className="pt-4 text-center">
            <button
              ...
              className="px-8 py-4 bg-[#F16736] text-white font-black text-xs uppercase tracking-wider rounded-lg transition hover:bg-[#F16736]/90 cursor-pointer shadow-md"
            >
      ...
      <section className="py-24 px-6 bg-[#faf9f7] text-center relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto space-y-6 relative z-10">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-[#fff1eb] border border-[#F16736]/20 rounded-md text-xs font-black uppercase text-[#F16736] tracking-widest">
            🎓 ACTIVE LEDGER
          </span>
          <h2 className="text-3xl md:text-5xl font-black text-[#1e1e1e] tracking-tight">
          ...
          <div className="pt-4">
            <Link href="/programs/cash-on-campus/detail"
              className="px-8 py-4 bg-neutral-900 hover:bg-neutral-800 text-white font-black text-xs uppercase tracking-widest rounded-lg transition inline-flex items-center gap-2 group cursor-pointer"
            >

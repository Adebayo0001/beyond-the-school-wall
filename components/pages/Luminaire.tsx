    ...
    <div className="min-h-screen bg-slate-50 font-sans selection:bg-orange-200">
        ...
        <div className="text-left">
          ...
          <nav className="p-6 bg-white border-b border-[#e8e5e0] flex items-center justify-between sticky top-0 z-30 shadow-sm">
            ...
            <div className="flex items-center gap-4">
              <Link href="/login" className="text-sm font-bold text-neutral-600 hover:text-[#1e1e1e] hidden sm:block">
                BTSW Portal
              </Link>
              <button 
                onClick={() => setActiveSegment('login')}
                className="px-5 py-2.5 bg-[#F16736] hover:bg-[#F16736]/90 text-white font-black text-xs uppercase tracking-wider rounded-lg transition-all shadow-md active:scale-95 cursor-pointer"
              >
                Go to Student Login
              </button>
            </div>
          ...
          <div className="relative overflow-hidden bg-gradient-to-b from-amber-50/40 via-white to-slate-50 py-16 md:py-24 px-6">
            ...
            <div className="max-w-4xl mx-auto text-center space-y-6">
              ...
              <div className="flex flex-wrap items-center justify-center gap-4 pt-6">
                <button 
                  onClick={() => setActiveSegment('login')}
                  className="px-8 py-4 bg-[#1e1e1e] hover:bg-[#F16736] text-white font-black text-sm rounded-lg transition-all shadow-lg active:scale-98 flex items-center gap-1.5 cursor-pointer"
                >
                  Enter Junior Workspace <ArrowRight size={16} />
                </button>
                <a 
                  href="#tracks-breakdown"
                  className="px-8 py-4 bg-white border border-[#e8e5e0] hover:border-zinc-400 text-neutral-700 font-black text-sm rounded-lg transition-all cursor-pointer"
                >
      ...
      {activeSegment === 'login' && (
        <div className="min-h-screen flex items-center justify-center p-6 text-left bg-[#fffcfb]">
          <div className="w-full max-w-md bg-white border border-[#F16736]/15 rounded-xl p-8 md:p-10 shadow-xl space-y-8 relative">
            ...
            <button 
              ...
              className="px-3.5 py-1.5 border border-neutral-200 hover:bg-neutral-50 text-neutral-500 font-extrabold text-xs uppercase tracking-wider rounded-lg transition-all flex items-center gap-1 w-max cursor-pointer"
            >
              ← Return
            </button>

            <div>
              <span className="text-[9px] font-black uppercase text-rose-500 bg-rose-50 px-3 py-1 rounded-md tracking-widest inline-block mb-3.5 border border-rose-100">
                LUMINAIRE CAMPUS
              </span>

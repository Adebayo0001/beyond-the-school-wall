...
const programs = [
  ...
  {
    title: "Inter Junior Workspace",
    slug: "inter-junior-workspace",
    kicker: "Ages 9–18 Skill Foundation",
    description: "Four foundational starter courses designed specifically for primary and secondary school learners in Applied AI, UI/UX Design, Creative Writing, and Rhetoric & Public Speaking. Complete with parent consent verification and direct student portal access.",
    features: [
      "4 Structured Starter Courses (Novice to Pro)",
      "Interactive AI & Creative Writing Sandboxes",
      "Verified Parental Consent & Student Certificates"
    ],
    cta: "Explore Junior Workspace",
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className={`flex flex-col ${isEven ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-12 lg:gap-24 items-center`}>
          ...
          >
            ...
            <button 
              onClick={() => router.push(program.slug === 'inter-junior-workspace' ? '/inter-junior-workspace' : `/programs/${program.slug}`)}
              className="group relative px-8 py-4 bg-[#F16736] text-white font-bold rounded-lg overflow-hidden transition-all hover:shadow-[0_0_40px_rgba(241,103,54,0.3)] active:scale-95 flex items-center gap-2"
            >
          ...
          >
            <div className={`relative aspect-[4/3] rounded-xl overflow-hidden border border-[#e8e5e0] shadow-xl group bg-white p-4`}>
      ...
      <header className="pt-32 pb-16 md:pt-48 md:pb-24 border-b border-[#e8e5e0] bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <motion.div
            ...
            className="max-w-3xl"
          >
            <Breadcrumbs variant="light" className="mb-6" />
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <motion.div 
            ...
            viewport={{ once: true }}
            className="relative p-12 md:p-20 bg-[#faf9f7] rounded-xl border border-[#e8e5e0] overflow-hidden text-center"
          >
            ...
            <div className="relative z-10">
              <div className="w-16 h-16 bg-[#fff1eb] rounded-lg flex items-center justify-center text-[#F16736] mx-auto mb-8 border border-[#F16736]/10">
              ...
              <button className="group relative px-10 py-5 bg-[#F16736] text-white font-black rounded-lg overflow-hidden transition-all hover:scale-105 hover:shadow-[0_0_40px_rgba(241,103,54,0.3)] active:scale-95 flex items-center gap-3 mx-auto">

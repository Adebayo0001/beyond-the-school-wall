        ...
        <main className="flex-1 p-6 md:p-10 max-w-5xl w-full mx-auto">
          <div className="mb-6 flex items-center justify-between">
            <Breadcrumbs 
              items={[
                { label: 'Home', href: '/' },
                { label: 'Admin Console', href: activeAdminTab === 'analytics' ? undefined : '#' },
                ...(activeAdminTab !== 'analytics' ? [{ label: activeAdminTab === 'courses' ? 'Curriculum Editor' : 'Student Cohorts' }] : [])
              ]}
              variant="light"
            />
          </div>
            ...
            <div className="space-y-8 text-left animate-fade">
              ...
              <div className="border border-[#e8e5e0] rounded-3xl p-6 bg-white shadow-sm space-y-4">
                ...
                <div className="space-y-3">
                  {[
                    { id: 'scenario-magnet-school', title: 'Skeptical Director Board Pitch (The Magnet School)', rate: '52% engagement', count: '14 runs completed' },
                    { id: 'scenario-cash-on-campus', title: 'The Tough Dorm Supplier (Cash On Campus)', rate: '35% engagement', count: '9 runs completed' },
                    { id: 'scenario-junior-rhetoric', title: 'Prose & Rhetoric Studio (Inter Junior Workspace)', rate: '13% engagement', count: '4 runs completed' },
                  ].map((scStat, scIdx) => (

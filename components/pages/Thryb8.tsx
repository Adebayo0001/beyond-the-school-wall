  ...
  return (
    <div className="bg-white min-h-screen text-[#1e1e1e] pt-24 pb-16">
      <div className="max-w-5xl mx-auto px-6 space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center text-left">
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <Link href="/register"
                className="px-8 py-4 bg-[#1e1e1e] hover:bg-[#F16736] text-white font-extrabold text-sm uppercase tracking-wider rounded-lg transition-all hover:shadow-lg cursor-pointer"
              >
                Apply Into Cohort
              </Link>
            </div>
          ...
          <div className="p-8 border border-[#e8e5e0] rounded-xl bg-[#faf9f7] relative space-y-6">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-4">
            {tracks.map((track, idx) => (
              <div key={idx} className="p-6 border border-[#e8e5e0] rounded-xl bg-white text-left space-y-3 shadow-sm hover:border-[#F16736]/30 transition-all">
        ...
        <div className="p-8 md:p-12 border border-[#e8e5e0] rounded-xl bg-neutral-50/50 flex flex-col md:flex-row items-center justify-between gap-8 text-left">
          ...
          <Link href="/register"
            className="px-8 py-4 bg-[#1e1e1e] hover:bg-[#F16736] text-white font-extrabold text-xs uppercase tracking-wider rounded-lg transition-all flex-shrink-0 text-center w-full md:w-auto cursor-pointer"
          >
